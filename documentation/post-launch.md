...
| Performance Item | Status | Team Responsable | Comments |
| ------ | ------ | ------ | ------ |
...
| Submit Sitemap XML to[ Google Search Console](https://search.google.com/search-console/welcome?utm_source=about-page) | ❌ only dev  | Backend |  |
